Memories::Application.routes.draw do
  ...
  match 'login', :controller => 'login', :action => 'index', :as => :login
  match 'logout', :controller => 'login', :action => 'logout', :as => :logout
  match 'registe', :controller => 'login', :action => 'registe', :as => :registe
  match 'validate_email' => 'login#validate_email', :as => :validate_email
  match 'validate_name' => 'login#validate_name', :as => :validate_name
